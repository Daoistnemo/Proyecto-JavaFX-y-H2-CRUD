...
CREATE CACHED TABLE "PUBLIC"."PEDIDOS"(
    ...
    "ID_CLIENTE" INTEGER NOT NULL,  -- Clave foránea hacia CLIENTES
    "FECHA_PEDIDO" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("ID_PEDIDO"),
    FOREIGN KEY ("ID_CLIENTE") REFERENCES "PUBLIC"."CLIENTES"("ID")  -- Relación con CLIENTES
);

-- Crear tabla DETALLE_PEDIDO
CREATE CACHED TABLE "PUBLIC"."DETALLES_PEDIDO"(
    "ID_DETALLE" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "ID_PEDIDO" INTEGER NOT NULL,  -- Relación con la tabla PEDIDOS
    "ID_CONEXION" INTEGER NOT NULL,  -- Relación con la tabla CONEXIONES
    ...
    FOREIGN KEY ("ID_PEDIDO") REFERENCES "PUBLIC"."PEDIDOS"("ID_PEDIDO"),  -- Relación con PEDIDOS
    FOREIGN KEY ("ID_CONEXION") REFERENCES "PUBLIC"."CONEXIONES"("ID")  -- Relación con CONEXIONES
);